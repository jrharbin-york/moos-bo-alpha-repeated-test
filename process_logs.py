...
poly0 = Polygon([(107,-101),(112,-106),(112,-113),(107,-118),(100,-118),(95,-113),(95,-106),(100,-101)])
poly1 = Polygon([(50,-30),(53,-33),(53,-38),(50,-42),(45,-42),(41,-38),(41,-33),(45,-30)])
poly2 = Polygon([(82,-65),(87,-70),(87,-76),(82,-81),(76,-81),(71,-76),(71,-70),(76,-65)])
poly3 = Polygon([(59,-101),(64,-105),(64,-112),(59,-116),(53,-116),(48,-112),(48,-105),(53,-101)])
poly4 = Polygon([(107,-38),(112,-43),(112,-49),(107,-54),(100,-54),(96,-49),(96,-43),(100,-38)])
...
def test_point_inside_shapes(x,y):
	...
	for poly in all_polys:
		if p.within(poly):
			print("VIOLATION DETECTED: Point " + str(p) + " is inside " + str(poly))
			return 1
		else:
			return 0
		...
		for line in origin_file:
			m = re.search(r'X=(.+),Y=(.+),SPD=(.+),HDG=(.+),TYPE=', line)
				...
				if (time < mission_end_time):
					...
					fout.write(str(time) + "," + str(x) + "," + str(y) + "," + speed + "," + str(violation) + "\n")
	fout.close()
